...
//        System.out.println(menu + menu2 + (price + price2) + "원");
        System.out.println(menu + menu2 + price + price2 + "원");
//        연산자의 우선 수위 떄문에  왼쪽부터 차례대로 연산을 진행하여 문자열과 숫자(6500)의 연산이 먼저 발생하고,
//        그 이후에 문자열과 두번쨰 숫자(2000)과의 연산이 발생하여 '로세티리 바베큐 세트 65002000원'이라는 형태로 출력됨


        System.out.println("\n-----증감 연산자-----\n");

//        전의 연산 혹은 후위 연산이 단독으로 사용될 경우 일반 연산자를 통해서 값을 증감 시키는 것과 차이가 없음
